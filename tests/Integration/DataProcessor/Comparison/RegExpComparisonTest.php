    ...
    public function comparisonDataProvider(): array
    {
        return [
            ...
            [
                true,
                $this->getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field1'], 'field'),
                $this->getValueConfiguration([ConstantValueSource::KEY_VALUE => 'lue1'], 'constant'),
            ],
            [
                false,
                $this->getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field1'], 'field'),
            ...
            [
                true,
                $this->getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field4'], 'field'),
                $this->getValueConfiguration([ConstantValueSource::KEY_VALUE => 'lue4b'], 'constant'),
                'any',
            ],
            [
                false,
            ...
            [
                true,
                $this->getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field4'], 'field'),
                $this->getValueConfiguration([ConstantValueSource::KEY_VALUE => '^value4[ab]$'], 'constant'),
                'all',
            ],
            [
                true,
