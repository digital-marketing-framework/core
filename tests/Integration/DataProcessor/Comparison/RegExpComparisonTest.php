...
#[CoversClass(RegExpComparison::class)]
class RegExpComparisonTest extends ComparisonTestBase
{
    ...
    public static function comparisonDataProvider(): array
    {
        return [
            ...
            [
                true,
                static::getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field1'], 'field'),
                static::getValueConfiguration([ConstantValueSource::KEY_VALUE => 'lue1'], 'constant'),
            ],
            [
                false,
                static::getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field1'], 'field'),
            ...
            [
                true,
                static::getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field4'], 'field'),
                static::getValueConfiguration([ConstantValueSource::KEY_VALUE => 'lue4b'], 'constant'),
                'any',
            ],
            [
                false,
            ...
            [
                true,
                static::getValueConfiguration([FieldValueSource::KEY_FIELD_NAME => 'field4'], 'field'),
                static::getValueConfiguration([ConstantValueSource::KEY_VALUE => '^value4[ab]$'], 'constant'),
                'all',
            ],
            [
                true,
